function sMap = som_make(D, algorithm, initalg, mapsize, training, varargin)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%% MARCO PUGLIA 09/10/2025: |mapsize|algorithm|initalg|training| changed as asked by Vinko Bandelj %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if nargin < 2 || isempty(algorithm), algorithm = 'batch'; end
if nargin < 3 || isempty(initalg),   initalg   = 'lininit'; end
if nargin < 4 || isempty(mapsize),   mapsize   = 'normal'; end
if nargin < 5 || isempty(training),  training  = 'default'; end
